 ...
 */
interface BetterScrollbarAdapter {
 ...
 */
val BetterScrollbarAdapter.maxScrollOffset: Double
    get() = (contentSize - viewportSize).coerceAtLeast(0.0)

internal class ScrollableBetterScrollbarAdapter(
...
/**
 * Base class for [LazyListBetterScrollbarAdapter] and [LazyGridBetterScrollbarAdapter],
 * and in the future maybe other lazy widgets that lay out their content in lines.
 */
internal abstract class LazyLineContentAdapterBetter : BetterScrollbarAdapter {
    ...
    override suspend fun scrollTo(scrollOffset: Double) {
        val distance = scrollOffset - this@LazyLineContentAdapterBetter.scrollOffset
...
internal class LazyListBetterScrollbarAdapter(
    private val scrollState: LazyListState
) : LazyLineContentAdapterBetter() {
...
internal class SliderAdapter(
    val adapter: BetterScrollbarAdapter,
